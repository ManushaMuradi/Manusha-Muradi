...
Developed an AI-powered virtual tutor for personalized learning using natural language queries, implementing RAG to fetch relevant content and generate accurate, context-aware responses. Built the system using Python, Streamlit, NLP, LLMs, and Vector Databases to enhance learning efficiency.
